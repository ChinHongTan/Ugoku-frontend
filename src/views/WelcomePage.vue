...
const loginUrl = ref(
  'https://discord.com/oauth2/authorize?client_id=1277272946519314533&response_type=code&redirect_uri=https%3A%2F%2Fapp.ugoku.moe%2Fauth%2Fdiscord&scope=identify+guilds'
)
